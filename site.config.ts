...
export const siteConfig = {
  ...
  doctolibUrl: "https://www.doctolib.de/physiotherapeut/berlin/praxis-name", // Replace with actual Doctolib URL
  calendlyUrl: "https://calendly.com/heinrichsommeil/30min", // Keep as backup or remove
